...
pub unsafe fn enable_visual_styles() {
    ...
    use winapi::{MAX_PATH, ULONG, ACTCTXW, ULONG_PTR, ICC_STANDARD_CLASSES, ICC_DATE_CLASSES, ICC_PROGRESS_CLASS,
      ICC_WIN95_CLASSES, INITCOMMONCONTROLSEX, ICC_TREEVIEW_CLASSES, ICC_TAB_CLASSES};
    ...
    let controls_classes = INITCOMMONCONTROLSEX {
        ...
        dwICC: ICC_DATE_CLASSES|ICC_STANDARD_CLASSES|ICC_PROGRESS_CLASS|ICC_WIN95_CLASSES|ICC_TREEVIEW_CLASSES|ICC_TAB_CLASSES
    };
