...
use nwg::{Ui, WindowT, MenuT, MenuItemT, ButtonT, dispatch_events, exit as nwg_exit};
use nwg::{Event};
...
pub fn main() {
    ...
    app.pack_control(&"Btn1", ButtonT{text: "TEST", position:(10, 10), size: (100, 30), visible: true, disabled: false, parent: "MainWindow"});
